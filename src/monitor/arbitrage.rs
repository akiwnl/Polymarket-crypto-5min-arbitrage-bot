...
pub struct ArbitrageDetector {
    ...
    max_depth: usize, // Max probe depth
...
impl ArbitrageDetector {
    pub fn new(min_profit_threshold: f64) -> Self {
        Self {
            ...
            min_order_value_usd: dec!(1.0), // Min order value $1
        }
    }
    ...
    fn find_best_opportunity(
        ...
        // Available shares at best ask: min of both sides, floored to 2 decimal places
    ...
    /// Print orderbook depth (debug level, reduce info log spam)
    fn print_orderbook_depth(
        ...
        // Level selection log moved to executor, prints price with slippage when executing arbitrage
    }

    /// Check orderbook for arbitrage opportunities
